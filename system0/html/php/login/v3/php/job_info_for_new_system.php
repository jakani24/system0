			...
			<div class="container">
				<?php
					...
					while($cnt!=0)
					{
						...
						echo("<tr><td>Erwartete Druckzeit</td><td>".round($json["job"]["estimatedPrintTime"],0)/60." Minuten</td></tr>");
						echo("<tr><td>Druckzeit</td><td>".$json["progress"]["printTime"]/60." Minuten</td></tr>");
						echo("<tr><td>Verbleibende Druckzeit</td><td>".$json["progress"]["printTimeLeft"]/60." Minuten</td></tr>");
